...
<table>
  <tr>
    <td align="center"><img src="docs/images/01_asset_login.png" width="230"><br><sub>회원가입, 자산 연동</sub></td>
    <td align="center"><img src="docs/images/02_asset_linked.png" width="230"><br><sub>홈, 연동된 자산 확인</sub></td>
    <td align="center"><img src="docs/images/03_home_empty.png" width="230"><br><sub>자산 상세</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/04_goal_region.png" width="230"><br><sub>조건 입력 (보증금 범위)</sub></td>
    <td align="center"><img src="docs/images/05_goal_deposit.png" width="230"><br><sub>목표 시점 선택</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/06_plans.png" width="230"><br><sub>진단, 추천 계획</sub></td>
    <td align="center"><img src="docs/images/07_plan_detail.png" width="230"><br><sub>대안 비교, 상세</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/08_home_goal.png" width="230"><br><sub>목표 홈, 진행률</sub></td>
    <td align="center"><img src="docs/images/09_goal_detail.png" width="230"><br><sub>목표 상세, 실거래 반영</sub></td>
    <td align="center"><img src="docs/images/10_saving_edit.png" width="230"><br><sub>저축 계획 수정</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="docs/images/11_peer_compare.png" width="230"><br><sub>또래 비교</sub></td>
    <td align="center"><img src="docs/images/12_mypage.png" width="230"><br><sub>마이페이지</sub></td>
  </tr>
</table>
...
- **문제**: 미래 집값 시뮬레이션 결과가 이론 기댓값보다 체계적으로 낮게 나옴. 테스트는 통과해 놓치기 쉬운 결함.
...
- **원인/해결**: REST Long-Running Task 패턴(`202 Accepted` + 폴링)으로 전환. `@Async` 자기 호출이 프록시를 안 타는 문제를 빈 분리로 해결하고, 서버 2대 환경을 위해 작업 상태를 Redis에 공유하도록 했습니다.
